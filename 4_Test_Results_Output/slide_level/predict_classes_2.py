...
def main():
	...
	model_dir = 'D:\\models\\slide_level\\'
	...
	if isinstance(model_files, list):
		end_range = len(model_files)#'27_class_cnn_color_1'
	else:
		end_range = 1
	...
	for model_counter in range(0, end_range):
		...
		model = load_model('D:\\models\\slide_level\\'+model_name)
		print('loaded ', model_name)
		save_dir = 'D:\\results\\slide_level\\'+model_name+'\\'
